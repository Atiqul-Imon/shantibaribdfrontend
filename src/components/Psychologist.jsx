...
function PsychiatristPsychologist() {
  ...
  const psychologists = [
    ...
    },
    {
      ...
      imgSrc:
        "https://res.cloudinary.com/db5yniogx/image/upload/t_Media%20Coverage/v1736852227/tanzinachoudhury01cloud_d92vrq.jpg",
    },
  ];
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {psychiatrists.map((psychiatrist) => (
                ...
                >
                  ...
                  />
                  <h4 className="font-semibold text-lg font-roboto">
                    {psychiatrist.name}
                  </h4>
