...
import { useSocialMeta } from "../hooks/useSocialMeta.jsx";
  ...
  return (
    <div>
      {useSocialMeta({
        ...
        description:
          "Empowering women in Bangladesh through comprehensive support programs",
        ogTitle: "About Shantibari | Women Empowerment Organization",
        ogDescription:
          "Discover our mission to support women through mental health services and entrepreneurship programs",
        image:
      ...
      >
        ...
        <div className="relative z-10 flex justify-center items-center h-full">
          <h1 className="text-5xl md:text-7xl text-white font-bold tracking-tight uppercase shadow-md">
            About Us
          </h1>
        </div>
      </section>
        ...
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-2/3 space-y-6">
            ...
            <p className="text-lg text-gray-800">
              <strong className="text-primary">Company Culture</strong>
              <br />
              ...
              support each other in attaining our goals. We believe that our
              team members are assets to us, hence their well-being is our
              foremost priority, which leads to ensuring the best service to our
        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <p className="text-lg text-gray-700">
              To empower women through education, advocacy, and support to
          ...
          <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <p className="text-lg text-gray-700">
              To create a world where women have equal opportunities and rights
        ...
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-2/3 mb-8 md:mb-0">
            ...
            <ul className="text-lg text-gray-700 space-y-4">
              <li>
                Supported 10,000+ women with mental health and legal services
                over the year
              </li>
              <li>
                Over 150,000 followers and adherents across the country through
                online platforms
              </li>
              <li>
                Supported a good number of women entrepreneurs and
                small-business owners
              </li>
              <li>
                Hosted numerous events, including sessions, conferences,
                workshops, exhibitions, webinars, etc.
              </li>
              <li>
                Collaborations with multiple companies to enhance our social
                offerings
              </li>
              <li>Strong financial performance and steady revenue growth</li>
              <li>
                The activities of Shantibari have been exclusively featured in
                both print and digital media including Prothom Alo, The Business
                Standard, Channel 24, etc.
              </li>
            </ul>
          </div>
